...
/-!
# Loop Rules for Monadic Support
...
therefore untagged. Universal rules need only lawful attachment; existential rules
add exact pure/bind composition.
-/
