...
/-!
# Typed interfaces and directed boundaries
...
Interfaces and their morphisms reuse `PFunctor`, charts, and lenses. Directed
boundaries package input and output interfaces with their corresponding variance.
