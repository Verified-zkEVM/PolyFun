...
/-!
# Contextual emulation relative to an observation

This module compares abstract open systems through observations of their closed composites.
Its `UCSecure` judgment quantifies over a supplied simulator space and context transformer.
A cryptographic interpretation additionally needs probability or computational observations
and their adequacy laws; those semantics are supplied downstream.
