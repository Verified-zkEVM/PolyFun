...
/-!
# Compatibility module for `PolyFun.Interaction.UC.Emulates`

The content now lives in `PolyFun.Interaction.Open.Emulates`.
...
deprecated_module "use `PolyFun.Interaction.Open.Emulates`"
  (since := "2026-09-26")
