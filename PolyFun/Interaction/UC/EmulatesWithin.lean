...
/-!
# Compatibility module for `PolyFun.Interaction.UC.EmulatesWithin`

The content now lives in `PolyFun.Interaction.Open.EmulatesWithin`.
...
deprecated_module "use `PolyFun.Interaction.Open.EmulatesWithin`"
  (since := "2026-09-26")
