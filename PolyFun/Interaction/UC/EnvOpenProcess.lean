...
/-!
# Compatibility module for `PolyFun.Interaction.UC.EnvOpenProcess`

The content now lives in `PolyFun.Interaction.Open.EnvOpenProcess`.
...
deprecated_module "use `PolyFun.Interaction.Open.EnvOpenProcess`"
  (since := "2026-09-26")
