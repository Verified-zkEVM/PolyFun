...
/-!
# Compatibility module for `PolyFun.Interaction.UC.Interface`

The content now lives in `PolyFun.Interaction.Interface`.
...
deprecated_module "use `PolyFun.Interaction.Interface`"
  (since := "2026-09-26")
