...
/-!
# Compatibility module for `PolyFun.Interaction.UC.Notation`

The content now lives in `PolyFun.Interaction.Open.Notation`.
...
deprecated_module "use `PolyFun.Interaction.Open.Notation`"
  (since := "2026-09-26")
