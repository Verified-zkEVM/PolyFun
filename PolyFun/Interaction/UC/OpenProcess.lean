...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcess`

The content now lives in `PolyFun.Interaction.Open.OpenProcess`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcess`"
  (since := "2026-09-26")
