...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcessCoherence`

The content now lives in `PolyFun.Interaction.Open.OpenProcessCoherence`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcessCoherence`"
  (since := "2026-09-26")
