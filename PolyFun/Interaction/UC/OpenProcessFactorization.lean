...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcessFactorization`

The content now lives in `PolyFun.Interaction.Open.OpenProcessFactorization`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcessFactorization`"
  (since := "2026-09-26")
