...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcessModel`

The content now lives in `PolyFun.Interaction.Open.OpenProcessModel`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcessModel`"
  (since := "2026-09-26")
