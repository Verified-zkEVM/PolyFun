...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcessQuotient`

The content now lives in `PolyFun.Interaction.Open.OpenProcessQuotient`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcessQuotient`"
  (since := "2026-09-26")
