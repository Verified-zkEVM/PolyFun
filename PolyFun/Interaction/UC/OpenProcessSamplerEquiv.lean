...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcessSamplerEquiv`

The content now lives in `PolyFun.Interaction.Open.OpenProcessSamplerEquiv`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcessSamplerEquiv`"
  (since := "2026-09-26")
