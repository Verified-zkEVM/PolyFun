...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenProcessSamplerFactorization`

The content now lives in `PolyFun.Interaction.Open.OpenProcessSamplerFactorization`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenProcessSamplerFactorization`"
  (since := "2026-09-26")
