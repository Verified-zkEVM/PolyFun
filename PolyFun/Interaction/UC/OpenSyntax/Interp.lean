...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenSyntax.Interp`

The content now lives in `PolyFun.Interaction.Open.OpenSyntax.Interp`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenSyntax.Interp`"
  (since := "2026-09-26")
