...
/-!
# Compatibility module for `PolyFun.Interaction.UC.OpenSyntax.Raw`

The content now lives in `PolyFun.Interaction.Open.OpenSyntax.Raw`.
...
deprecated_module "use `PolyFun.Interaction.Open.OpenSyntax.Raw`"
  (since := "2026-09-26")
