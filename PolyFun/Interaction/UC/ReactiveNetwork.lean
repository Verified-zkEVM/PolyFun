...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork`"
  (since := "2026-09-26")
