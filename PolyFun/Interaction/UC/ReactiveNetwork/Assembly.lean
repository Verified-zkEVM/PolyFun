...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Assembly`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Assembly`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Assembly`"
  (since := "2026-09-26")
