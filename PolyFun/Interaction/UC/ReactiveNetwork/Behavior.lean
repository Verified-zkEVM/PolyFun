...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Behavior`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Behavior`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Behavior`"
  (since := "2026-09-26")
