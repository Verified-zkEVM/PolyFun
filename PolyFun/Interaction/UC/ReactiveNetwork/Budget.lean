...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Budget`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Budget`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Budget`"
  (since := "2026-09-26")
