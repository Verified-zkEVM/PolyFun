...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Diagram`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Diagram`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Diagram`"
  (since := "2026-09-26")
