...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Factorization`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Factorization`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Factorization`"
  (since := "2026-09-26")
