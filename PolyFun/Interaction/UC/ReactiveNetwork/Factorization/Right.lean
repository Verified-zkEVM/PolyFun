...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Factorization.Right`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Factorization.Right`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Factorization.Right`"
  (since := "2026-09-26")
