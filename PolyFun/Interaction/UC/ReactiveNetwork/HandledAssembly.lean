...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.HandledAssembly`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.HandledAssembly`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.HandledAssembly`"
  (since := "2026-09-26")
