...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Serial`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Serial`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Serial`"
  (since := "2026-09-26")
