...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveNetwork.Transport`

The content now lives in `PolyFun.Interaction.Execution.ReactiveNetwork.Transport`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveNetwork.Transport`"
  (since := "2026-09-26")
