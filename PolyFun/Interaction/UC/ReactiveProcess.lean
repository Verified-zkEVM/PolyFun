...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ReactiveProcess`

The content now lives in `PolyFun.Interaction.Execution.ReactiveProcess`.
...
deprecated_module "use `PolyFun.Interaction.Execution.ReactiveProcess`"
  (since := "2026-09-26")
