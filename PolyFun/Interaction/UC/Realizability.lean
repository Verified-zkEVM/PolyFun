...
/-!
# Compatibility module for `PolyFun.Interaction.UC.Realizability`

The content now lives in `PolyFun.Interaction.Open.Realizability`.
...
deprecated_module "use `PolyFun.Interaction.Open.Realizability`"
  (since := "2026-09-26")
