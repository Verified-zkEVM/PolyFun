...
/-!
# Compatibility module for `PolyFun.Interaction.UC.RequestNetwork`

The content now lives in `PolyFun.Interaction.Execution.RequestNetwork`.
...
deprecated_module "use `PolyFun.Interaction.Execution.RequestNetwork`"
  (since := "2026-09-26")
