...
/-!
# Compatibility module for `PolyFun.Interaction.UC.RequestNetwork.Serial`

The content now lives in `PolyFun.Interaction.Execution.RequestNetwork.Serial`.
...
deprecated_module "use `PolyFun.Interaction.Execution.RequestNetwork.Serial`"
  (since := "2026-09-26")
