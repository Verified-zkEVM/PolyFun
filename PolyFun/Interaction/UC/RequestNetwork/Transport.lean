...
/-!
# Compatibility module for `PolyFun.Interaction.UC.RequestNetwork.Transport`

The content now lives in `PolyFun.Interaction.Execution.RequestNetwork.Transport`.
...
deprecated_module "use `PolyFun.Interaction.Execution.RequestNetwork.Transport`"
  (since := "2026-09-26")
