...
/-!
# Compatibility module for `PolyFun.Interaction.UC.SamplerObservation`

The content now lives in `PolyFun.Interaction.Open.SamplerObservation`.
...
deprecated_module "use `PolyFun.Interaction.Open.SamplerObservation`"
  (since := "2026-09-26")
