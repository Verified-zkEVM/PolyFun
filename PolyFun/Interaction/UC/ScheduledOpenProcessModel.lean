...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ScheduledOpenProcessModel`

The content now lives in `PolyFun.Interaction.Open.ScheduledOpenProcessModel`.
...
deprecated_module "use `PolyFun.Interaction.Open.ScheduledOpenProcessModel`"
  (since := "2026-09-26")
