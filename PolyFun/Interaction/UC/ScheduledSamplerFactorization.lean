...
/-!
# Compatibility module for `PolyFun.Interaction.UC.ScheduledSamplerFactorization`

The content now lives in `PolyFun.Interaction.Open.ScheduledSamplerFactorization`.
...
deprecated_module "use `PolyFun.Interaction.Open.ScheduledSamplerFactorization`"
  (since := "2026-09-26")
