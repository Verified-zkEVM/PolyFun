...
mass-aware theory. This relation does not compare masses. Component congruence
under a mass-sensitive scheduler additionally needs equality of masses or a
transport law for the resulting scheduler draws. -/
