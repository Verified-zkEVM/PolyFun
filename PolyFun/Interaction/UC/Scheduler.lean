...
/-!
# Compatibility module for `PolyFun.Interaction.UC.Scheduler`

The content now lives in `PolyFun.Interaction.Open.Scheduler`.
...
deprecated_module "use `PolyFun.Interaction.Open.Scheduler`"
  (since := "2026-09-26")
