...
/-!
# Compatibility module for `PolyFun.Interaction.UC.SecureEmulation`

The content now lives in `PolyFun.Interaction.Open.SecureEmulation`.
...
deprecated_module "use `PolyFun.Interaction.Open.SecureEmulation`"
  (since := "2026-09-26")
