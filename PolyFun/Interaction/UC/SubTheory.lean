...
/-!
# Compatibility module for `PolyFun.Interaction.UC.SubTheory`

The content now lives in `PolyFun.Interaction.Open.SubTheory`.
...
deprecated_module "use `PolyFun.Interaction.Open.SubTheory`"
  (since := "2026-09-26")
