...
/-- Whole-handler transport acts pointwise by the existing free-tree
...
/-- Displayed left identity over the ordinary free-handler left-unit law. -/
theorem id_comp
    {P : PFunctor.{uA, u}} {Q : PFunctor.{uA', u}}
    {S : Display.{uA, u, uC, uD} P}
    {T : Display.{uA', u, uC', uD'} Q}
...
/-- Displayed associativity over ordinary free-handler associativity.  The
transport is essential: the two displayed composites live over
propositionally, not definitionally, equal free programs. -/
theorem comp_assoc
    {P : PFunctor.{uA, u}} {Q : PFunctor.{uA', u}}
    {R : PFunctor.{uA'', u}}
    {S : Display.{uA, u, uC, uD} P}
