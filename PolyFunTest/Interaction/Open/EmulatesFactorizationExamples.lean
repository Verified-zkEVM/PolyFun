...
`PolyFun.Interaction.Open.ActivationObservation` and is exercised in
...
namespace Interaction.Open.EmulatesFactorizationExamples
...
end Interaction.Open.EmulatesFactorizationExamples
