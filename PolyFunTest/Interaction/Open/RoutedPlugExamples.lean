...
namespace PolyFunTest.Interaction.Open.RoutedPlugExamples

open _root_.Interaction _root_.Interaction.Open
...
end PolyFunTest.Interaction.Open.RoutedPlugExamples
