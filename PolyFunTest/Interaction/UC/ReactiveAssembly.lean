...
namespace Interaction.UC.ReactiveNetwork.AssemblyTests

open PFunctor ReactiveProcess DynSystem OpenSyntax
...
end Interaction.UC.ReactiveNetwork.AssemblyTests
