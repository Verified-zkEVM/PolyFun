# Open systems and contextual emulation

An open system interacts through a typed boundary. `Interaction.Open` supplies
composition operations, concrete process models, and judgments that compare
systems after closing their boundaries with contexts. Start with
[OpenTheory](../../PolyFun/Interaction/Open/OpenTheory.lean) for the algebra,
[OpenProcess](../../PolyFun/Interaction/Open/OpenProcess.lean) for a process
model, and [Emulates](../../PolyFun/Interaction/Open/Emulates.lean) for the
observer-relative judgment. [Execution](execution.md) covers executable networks.

This guide records exactly which observations the composition laws preserve.
Its paper comparison uses Farshim, Karvonen, Knispel, Kohlweiss, and Wadler,
*UC, Categorically: Rigorous Diagrammatic Proofs*, cited in
[the bibliography](../../REFERENCES.md). See [PolyFun and VCVio](polyfun-and-vcvio.md)
for the distinction from instantiated cryptographic UC security.
...
systems. Probability, distinguishing advantage, negligibility, and cryptographic
security games are VCVio instantiations. Generic resource bounds and optional
complexity certificates are covered by [realizability](realizability.md).
...
[`MomentaryCorruption.lean`](../../PolyFunTest/Interaction/Open/MomentaryCorruption.lean)
...
[`ReactiveProcess`](../../PolyFun/Interaction/Execution/ReactiveProcess.lean) expresses local effects,
...
[`ReactiveNetwork`](../../PolyFun/Interaction/Execution/ReactiveNetwork.lean) assigns stable identities
...
[`Transport`](../../PolyFun/Interaction/Execution/ReactiveNetwork/Transport.lean) proves that a
...
[`Diagram`](../../PolyFun/Interaction/Execution/ReactiveNetwork/Diagram.lean) separates typed
...
[factorization laws](../../PolyFun/Interaction/Execution/ReactiveNetwork/Factorization.lean) and
[right-component laws](../../PolyFun/Interaction/Execution/ReactiveNetwork/Factorization/Right.lean)
...
[assembly regressions](../../PolyFunTest/Interaction/Execution/ReactiveAssembly.lean) distinguish
its charged eight-step echo from a direct four-step exchange. No timed snake equation
is assumed. The [factorization consumer](../../PolyFunTest/Interaction/Execution/ReactiveFactorization.lean)
...
[`HandledDiagram`](../../PolyFun/Interaction/Execution/ReactiveNetwork/HandledDiagram.lean) and
[`HandledAssembly`](../../PolyFun/Interaction/Execution/ReactiveNetwork/HandledAssembly.lean) carry
...
adding relay nodes. The [handler tests](../../PolyFunTest/Interaction/Execution/ReactiveHandlers.lean)
...
[`Behavior`](../../PolyFun/Interaction/Execution/ReactiveNetwork/Behavior.lean) proves exact adequacy:
...
[`Serial`](../../PolyFun/Interaction/Execution/ReactiveNetwork/Serial.lean) gives a deliberately
...
[`Budget`](../../PolyFun/Interaction/Execution/ReactiveNetwork/Budget.lean) proves exact elapsed counts
...
The [budget tests](../../PolyFunTest/Interaction/Execution/ReactiveBudget.lean) admit a countdown,
...
an atomic shared handler. Its [serial theorem](../../PolyFun/Interaction/Execution/RequestNetwork/Serial.lean)
...
See [realizability](realizability.md) for available certificates and their
