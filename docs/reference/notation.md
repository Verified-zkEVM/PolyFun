...
This page lists the principal polynomial, interaction, and support notation; the canonical definitions live in the
referenced Lean source.

## Open-system composition notation

Scoped to `Interaction.Open` (activated by `open Interaction.Open`). Defined
in
[`PolyFun/Interaction/Open/Notation.lean`](../../PolyFun/Interaction/Open/Notation.lean).
