...
| `ScheduledSamplerFactorization.lean` | Public bind equations for the mass-aware hierarchical draws and `samplePath_interleave_assoc_left` / `samplePath_interleave_assoc_right`, which lift scheduler coherence through arbitrary component samplers along the structural path reassociations. |
