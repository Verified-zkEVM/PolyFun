...
| [`PolyFun/PFunctor/Display/Parallel/Lens.lean`](../../PolyFun/PFunctor/Display/Parallel/Lens.lean) | Fiberwise parallel map, unitors, braiding, and associator, with transported naturality, involutivity, pentagon, triangle, and hexagon laws. |
...
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel.lean) | Product-state lockstep responders over `P ∥ Q`; one-sided steps freeze the inactive state and joint steps advance both. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Display.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Display.lean) | Componentwise proof-relevant responder coalgebras for separable parallel displays, with exact left/right/joint obligation equations. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Behavior.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Behavior.lean) | Ordinary and verified state-free lockstep behavior, presentation agreement, branch observations, and the strict displayed-to-base projection law. |
...
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Compatibility.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Compatibility.lean) | Operational compatibility of synchronized free-program execution and responder reindexing, including the formal counterexample to unrestricted handler interchange. |
...
| [`PolyFun/PFunctor/Free/Parallel.lean`](../../PolyFun/PFunctor/Free/Parallel.lean) | One-sided embeddings and synchronized parallel execution of free programs and handlers, including residual execution after one component returns and structural coherence laws. |
