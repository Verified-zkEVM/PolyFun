...
| [`PolyFun/PFunctor/Dynamical/Responder/VerifiedPresentation.lean`](../../PolyFun/PFunctor/Dynamical/Responder/VerifiedPresentation.lean) | Proof-relevant homomorphisms between responder presentations: state and dependent-witness maps preserving the complete totalized verified step, with identity, composition, terminal semantics, and state-free naturality. |
| [`PolyFun/PFunctor/Dynamical/Responder/Lens.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Lens.lean) | Ordinary and verified state-free reindexing along polynomial/display lenses, including heterogeneous response universes and transported identity/composition laws. |
