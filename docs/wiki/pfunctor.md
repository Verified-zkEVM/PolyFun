...
| [`PolyFun/PFunctor/Display/Parallel/Free.lean`](../../PolyFun/PFunctor/Display/Parallel/Free.lean) | Displayed synchronized free programs and componentwise displayed free handlers, with constructor equations for all one-sided and joint branches. |
