...
| [`PolyFun/PFunctor/Parallel.lean`](../../PolyFun/PFunctor/Parallel.lean) | The one-or-both interface `P ∥ Q`, its decomposition as `(P + Q) + (P ⊗ Q)`, lens action, unitors, braiding, associator, and concrete coherence laws. |
...
| [`PolyFun/PFunctor/Display/Handler.lean`](../../PolyFun/PFunctor/Display/Handler.lean) | Displayed handlers, hom-fiber transport, free extension, Kleisli composition, and transported identity/associativity laws. |
| [`PolyFun/PFunctor/Display/Lens.lean`](../../PolyFun/PFunctor/Display/Lens.lean) | Fiberwise lifts of polynomial lenses; identity, composition, base-index transport, faithful total-polynomial semantics, and embedding into one-operation displayed handlers. |
| [`PolyFun/PFunctor/Display/Parallel.lean`](../../PolyFun/PFunctor/Display/Parallel.lean) | General left/right/joint relational displays over `P ∥ Q`, strict component decomposition, heterogeneous evidence assembly with canonical branch equivalences, and the separable display used by the paper. |
| [`PolyFun/PFunctor/Display/Parallel/Free.lean`](../../PolyFun/PFunctor/Display/Parallel/Free.lean) | Displayed synchronized free programs and componentwise displayed free handlers, with constructor equations for all one-sided and joint branches and transported identity coherence. |
...
| [`PolyFun/PFunctor/Display/Parallel/Lens.lean`](../../PolyFun/PFunctor/Display/Parallel/Lens.lean) | Fiberwise parallel map, the canonical coproduct-to-parallel embedding, unitors, braiding, and associator, with transported naturality, involutivity, pentagon, triangle, and hexagon laws. |
...
| [`PolyFun/PFunctor/Wiring/Parallel.lean`](../../PolyFun/PFunctor/Wiring/Parallel.lean) | Parallel evaluation of two recursive wirings, retaining two explicit copies of the external interface rather than silently contracting a shared resource. |
...
| [`PolyFun/PFunctor/Dynamical/Responder/VerifiedPresentation.lean`](../../PolyFun/PFunctor/Dynamical/Responder/VerifiedPresentation.lean) | Proof-relevant homomorphisms between verified responder presentations, with split state/witness maps preserving dependent indexing, faithful total-step semantics, identity and composition, terminal naturality, and the bridge between presented and state-free verified behavior. |
| [`PolyFun/PFunctor/Dynamical/Responder/Lens.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Lens.lean) | One-step ordinary and verified behavior reindexing along polynomial and fiberwise lenses, with exact observations and identity/composition laws. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel.lean) | Product-state responders over both `P + Q` and `P ∥ Q`; one-sided steps freeze the inactive state and joint parallel steps advance both. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Display.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Display.lean) | Componentwise proof-relevant responder coalgebras for coproduct and separable parallel displays, with exact branch obligation equations. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Behavior.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Behavior.lean) | Ordinary and verified state-free coproduct and lockstep behavior, presentation agreement, branch observations, and the strict displayed-to-base projection law. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Coherence.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Coherence.lean) | Structural left/right unit, symmetry, and associativity laws for ordinary state-free lockstep parallel behavior. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/VerifiedPresentation.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/VerifiedPresentation.lean) | Componentwise parallel composition of verified presentation homomorphisms, with projection, identity, and interchange laws; this bifunctoriality does not assert unrestricted Kleisli interchange for free handlers. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/VerifiedAssociativity.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/VerifiedAssociativity.lean) | The verified parallel associator between explicit responder presentations and its transport to canonical state-free verified behavior. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/VerifiedCoherence.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/VerifiedCoherence.lean) | Public proof-relevant parallel coherence umbrella, adding canonical empty evidence and transported symmetry and unit laws to verified associativity. |
| [`PolyFun/PFunctor/Dynamical/Responder/Parallel/Compatibility.lean`](../../PolyFun/PFunctor/Dynamical/Responder/Parallel/Compatibility.lean) | The identification of coproduct responders with parallel responders restricted along the canonical lens, plus operational compatibility of synchronized free-program execution and responder reindexing, including the formal counterexample to unrestricted handler interchange. |
...
| [`PolyFun/PFunctor/Free/Parallel.lean`](../../PolyFun/PFunctor/Free/Parallel.lean) | The canonical coproduct-to-parallel lens, one-sided embeddings, and synchronized parallel execution of free programs and handlers, including residual execution after one component returns and structural coherence laws. |
...
| [`PolyFun/PFunctor/PatternRunsOnMatter/Parallel.lean`](../../PolyFun/PFunctor/PatternRunsOnMatter/Parallel.lean) | Compatibility of evaluated Pattern-Runs-on-Matter execution with parallel responder reindexing. |
