...
| [`PolyFun/PFunctor/Free/Cursor/Refork.lean`](../../PolyFun/PFunctor/Free/Cursor/Refork.lean) | Locating occurrences in completed paths, total reforking from a located context, fixed and dynamically selected optional reforking, observation fusion, and the prefix-first/path-first factorization theorem. |
