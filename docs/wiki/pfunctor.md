...
| [`PolyFun/PFunctor/Free/WP.lean`](../../PolyFun/PFunctor/Free/WP.lean) | Syntactic and handler-relative weakest preconditions, canonical demonic/angelic operation specs, and the admitted-response `LeavesSatisfyUnder` contract with bind, map, and free-handler closure. The leaf contract is partial correctness and supplies no progress claim. |
