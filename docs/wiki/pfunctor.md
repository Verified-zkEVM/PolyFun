...
| [`PolyFun/PFunctor/Comonoid/Tensor.lean`](../../PolyFun/PFunctor/Comonoid/Tensor.lean) | The composition-unit comonoid, heterogeneous tensor product of composition comonoids built from duoidal interchange, componentwise tensor of retrofunctors, and pointwise tensor-unit/associativity isomorphisms. This is the concrete object/morphism and coherence construction behind Proposition 8.79, not abstract monoidal-category or natural-isomorphism packaging, pentagon/triangle laws, or the categorical-product universal property. |
