...
| [`PolyFun/PFunctor/Free/Context.lean`](../../PolyFun/PFunctor/Free/Context.lean) | Path-independent `Occurrence` contexts, certified execution splitting, completion, and prefix-first `forkAt`. |
| [`PolyFun/PFunctor/Free/Refork.lean`](../../PolyFun/PFunctor/Free/Refork.lean) | Locating contexts in completed paths, fixed and dynamically selected reforking, observation fusion, and the prefix-first/path-first factorization theorem. |
